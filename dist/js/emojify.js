(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        var emojify = (function () {
            ...
            /* :-o  */ open_mouth: /:-?o/gi,
            /* >:-o */ angry: /\\>:-?\(/gi,
            /* :-p  */ stuck_out_tongue: /:-?[pb]/gi,
            /* ;-p  */ stuck_out_tongue_winking_eye: /;-?[pb]/gi,
            /* X-p  */ stuck_out_tongue_closed_eyes: /x-?[pb]/gi,
            /* :-]  */ smirk: /[:;]-?]/g,
      /* :-[ / :-@  */ rage: /:-?[\[@]/g,
            /* :-s  */ confounded: /:-?s/gi,
            /* :-$  */ relaxed: /:-?\$/g
            ...
            Validator.prototype = {
                validate: function(match, index, input) {
                    ...
                    // Required to parse smiley like "word:smiley:" but skip emoticons like ":)" inside words
                    if (match[1]) { return success() }
